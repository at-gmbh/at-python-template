...
with warnings.catch_warnings():
    ...
    if Version(platform.python_version()) < Version("3.10.0"):
        print(
            f"ERROR: You are using Python {platform.python_version()},",
    ...
    if Version(cookiecutter.__version__) < Version("1.7.2"):
        print(
            f"ERROR: You are using cookiecutter {cookiecutter.__version__}"
...
if not re.match(SLUG_REGEX, project_slug):
    print(
        f"ERROR: {project_slug} is not a valid slug! "
